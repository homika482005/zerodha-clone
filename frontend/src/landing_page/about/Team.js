      ...
      style={{lineHeight: "1.8", fontSize:"1 .2em"}}>
         ...
         <div className="col-6 p-5"> 
              <p>
                  ...
                  hurdles he faced during his decode long stine as a trader. 
                  Today,Zerodha has changed the landscape of the Indian broking industry.
              </p>
              <p>
                He is a member of the SEBI Secondary Market Advisory Committe (SMAC) and 
                the Market Date Advisory Committee (MDAC).
              </p>
