        ...
        <div className="container py-5">
            <div className="row mt-5">
                ...
                <div className="col-4 p-5 mt-2 mb-2">
                    ...
                    <br />
                     <a href=""style={{textDecoration: "none", lineHeight: "2.5"}}>Zerodha IDFC Bank 3-in-1 Account</a>
                    <br />
                 ...
                 <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="">
                        <i className="  fa-solid fa-chart-column " aria-hidden="true"></i>Your Zerodha Account
                    </h4>
                 ...
                 <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="">
                        <i className="fa-solid fa-wallet"aria-hidden="true"></i> Funds
                    </h4>
                 ...
                 <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="">
                        <i className=" fa-regular fa-circle"aria-hidden="true" ></i> Console
                    </h4>
